(function(app){
	...
	app.controller('startCtrl',["$scope","startService","$state",
	function($scope,startService,$state){
	
		
  $scope.start = function () {
	      startService.start().then(function (result) {
...
//              alert(result);
	...
	app.controller('smallCtrl',["$scope","startService","$state","msg",
	function($scope,startService,$state,msg){
        ...
        $scope.small= function (init) {
            ...
            startService.small(type, $scope.filter.pageIndex, $scope.vm.pace,$scope.vm.like).then(function (result) {
                $scope.filter.pageIndex++;
//           
//              var more = (result.data.data.passenger_routes.data.length >= $scope.filter.pageSize);
//              $scope.filter.hasMore = more;
//              $scope.items = $scope.items.concat(result.data.data.passenger_routes.data);
                if (init) {
...
//	         startService.small($scope.vm.like, $scope.data.repeatSelect,$scope.vm.skip,$scope.vm.classify).then(function (result) {
//              msg.hide();
//             
//             
//          }, function (error) {
...
//          }
	...
	app.controller('outdoorCtrl',["$scope","startService","$state",
	function($scope,startService,$state){
		
	}]);
	
	app.controller('activedetailsCtrl',["$scope","startService","$state","$location", "$anchorScroll","$ionicScrollDelegate",
	function($scope,startService,$state,$location, $anchorScroll,$ionicScrollDelegate){
		datechange();
	...
	app.controller('liveCtrl',["$scope","startService","$state",
	function($scope,startService,$state){
		
	}]);
	
	
	app.controller('abroadCtrl',["$scope","startService","$state",
	function($scope,startService,$state){
		
	}]);
	
		app.controller('pannelCtrl',["$scope","startService","$state",
	function($scope,startService,$state){
		...
		app.controller('hotelCtrl',["$scope","startService","$state","$location", "$anchorScroll","$ionicScrollDelegate",
	function($scope,startService,$state,$location, $anchorScroll,$ionicScrollDelegate){
		 hotelbtn1();
               hotelbtn2();
               hotelbtn3();
		...
		app.controller('hotelorderCtrl',["$scope","startService","$state",
	function($scope,startService,$state){
		
	}]);
	
		app.controller('addplaceCtrl',["$scope","startService","$state",
	function($scope,startService,$state){
	...
	app.controller('ordermessCtrl',["$scope","startService","$state", "$ionicModal","$ionicPopup",
	function($scope,startService,$state, $ionicModal,$ionicPopup){
	...
	app.controller('payorder2Ctrl',["$scope","startService","$state",
	function($scope,startService,$state){
		...
		app.controller('payCtrl',["$scope","startService","$state",
	function($scope,startService,$state){
