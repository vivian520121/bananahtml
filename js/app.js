...
angular.module("myApp",["ionic"])
    .config(function($stateProvider,$urlRouterProvider,$ionicConfigProvider){
        ...
        $ionicConfigProvider.platform.
        ios.views.transition('ios');
             ...
             .state("frame.activedetails",{
                ...
                views:{
                    "start":{
                        ...
                        controller:function($scope,$location, $anchorScroll,$ionicScrollDelegate){
                   　    $scope.toTopScroll = function(){
                        $scope.showTop = $ionicScrollDelegate.getScrollPosition().top>500?true:false;
...
//
   ...
   .controller( 'actionsheetCtl',['$scope','$ionicActionSheet',function($scope,$ionicActionSheet){
              $scope.show = function() {
...
//                      { text: '关闭' }
 ...
 $ionicModal.fromTemplateUrl('templates/email.html', {
   ...
   .controller('BuyCtrl', function($scope, $ionicModal) {
    ...
    .controller('hotelCtrl', function($scope,$location, $anchorScroll,$ionicScrollDelegate) {
              hotelbtn1();
               hotelbtn2();
               hotelbtn3();
                   　    $scope.toTopScroll = function(){
                        $scope.showTop = $ionicScrollDelegate.getScrollPosition().top>400?true:false;
	   ...
	   .controller('OrderCtrl', function($scope, $ionicModal,$ionicPopup) {
